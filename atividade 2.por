programa
{
	...
	funcao inicio()
	{
		...
		
		{
			...
			{
				escreva (" Vez do jogador precione a para rolar o dado \n")
				leia(enter)
			...
			se (jogador == 5 ou jogador ==10 ou jogador ==15 ou jogador ==20)
				{
					escreva (" Jogador rolou o numero ", sorteio, " e moveu-se para a posição ", jogador, "  avance mais 3 espaços ",  "\n")
					jogador = jogador + 3
				}
			...
			senao 
				{
					escreva (" Jogador rolou o numero ",  sorteio , " e moveu-se para a posição ",  jogador, "\n")
			...
			se (sorteio == 6)
				{
					escreva (" O computador rolou o numero 6 e ganhou mais uma jogada \n")
					sorteio = u.sorteia(1, 6)
					computador = computador + sorteio
					escreva (" Computador rolou o numero ", sorteio , " e moveu-se para a posição ", computador, "\n")
				}
			senao se (computador == 5 ou computador ==10 ou computador ==15 ou computador ==20)
				{
					escreva (" Computador rolou o numero ", sorteio, " e moveu-se para a posição ", computador, " avance mais 3 espaços ",  "\n")
